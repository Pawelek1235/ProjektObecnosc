...
export class AttendMeBackendClientBase {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as AttenderGroup)
        return result200
      })
    } else if (status === 403) {
      return response.text().then((_responseText) => {
  ...
  attendergroupMemberAdd(
    ...
    if (attenderGroupId === null) throw new Error("The parameter 'attenderGroupId' cannot be null.")
  ...
  protected processCourseSave(response: Response): Promise<Course> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null
        result200 =
          _responseText === '' ? null : (JSON.parse(_responseText, this.jsonParseReviver) as Course)
        return result200
      })
    } else if (status === 403) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as CourseGroup)
        return result200
      })
    } else if (status === 403) {
      return response.text().then((_responseText) => {
  ...
  courseGroupAttenderUserAdd(
    ...
    if (courseGroupId === null) throw new Error("The parameter 'courseGroupId' cannot be null.")
  ...
  courseGroupTeacherAssign(
    ...
    if (courseGroupId === null) throw new Error("The parameter 'courseGroupId' cannot be null.")
      ...
      url_ += 'courseGroupId=' + encodeURIComponent('' + courseGroupId) + '&'
    if (teacherUserId === null) throw new Error("The parameter 'teacherUserId' cannot be null.")
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as CourseSessionListItem)
        return result200
      })
    } else if (status === 403) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as AttendanceLog[])
        return result200
      })
    } else if (status === 403) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as CourseSession)
        return result200
      })
    } else if (status === 403) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as CourseSessionListItemPagedList)
        return result200
      })
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as CourseSessionAttendanceRecord[])
        return result200
      })
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  courseSessionAttendanceScannerTokenGet(
    ...
    if (courseSessionId === null) throw new Error("The parameter 'courseSessionId' cannot be null.")
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as TokenResult)
        return result200
      })
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  courseSessionAttendanceRegister(attenderToken: string | undefined): Promise<User> {
    ...
    if (attenderToken === null) throw new Error("The parameter 'attenderToken' cannot be null.")
  ...
  protected processCourseSessionAttendanceRegister(response: Response): Promise<User> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null
        result200 =
          _responseText === '' ? null : (JSON.parse(_responseText, this.jsonParseReviver) as User)
        return result200
      })
    } else if (status === 400) {
      return response.text().then((_responseText) => {
  ...
  courseSessionAttendanceToggle(
    ...
    if (attendingUserId === null) throw new Error("The parameter 'attendingUserId' cannot be null.")
    else if (attendingUserId !== undefined)
      url_ += 'attendingUserId=' + encodeURIComponent('' + attendingUserId) + '&'
    if (courseSessionId === null) throw new Error("The parameter 'courseSessionId' cannot be null.")
    else if (courseSessionId !== undefined)
      url_ += 'courseSessionId=' + encodeURIComponent('' + courseSessionId) + '&'
    if (addOrRemove === null) throw new Error("The parameter 'addOrRemove' cannot be null.")
  ...
  userLogin(loginName: string | undefined, password: string | undefined): Promise<TokenResult> {
    ...
    if (loginName === null) throw new Error("The parameter 'loginName' cannot be null.")
  ...
  userDeviceReset(deviceUserId: number | undefined): Promise<void> {
    ...
    if (deviceUserId === null) throw new Error("The parameter 'deviceUserId' cannot be null.")
  ...
  protected processUserStudentCreate(response: Response): Promise<number> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null
        result200 =
          _responseText === '' ? null : (JSON.parse(_responseText, this.jsonParseReviver) as number)
        return result200
      })
    } else if (status === 403) {
      return response.text().then((_responseText) => {
